...
/// Prominent continue-reading card for the My Texts library header section.
struct ReadingContinueTextCardView: View {
    let title: String
    ...
    var body: some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: Layout.cardCornerRadius, style: .continuous)
                .fill(
                    LinearGradient(
                        colors: [accent.opacity(0.08), Color.white.opacity(0.96)],
