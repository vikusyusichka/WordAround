...
/// Friendly empty state for the My Texts library when no texts are saved yet.
struct ReadingMyTextsEmptyStateView: View {
    let onAddText: () -> Void
...
#Preview {
    ZStack {
        ...
        ReadingMyTextsEmptyStateView(onAddText: {})
            .padding()
    }
}
