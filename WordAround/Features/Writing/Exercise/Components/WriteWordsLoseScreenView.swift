...
struct WriteWordsLoseScreenView: View {
    ...
    private var header: some View {
        VStack(spacing: Layout.writeWordsLoseHeaderSpacing) {
            ...
            Text("The hard mode timer reached zero. Try again from the first word.")
                .font(.system(
    ...
    private var statsCard: some View {
        VStack(spacing: Layout.writeWordsLoseStatsSpacing) {
            statRow(title: "Words completed", value: "\(stats.completedWords)")
            divider
            statRow(title: "Streak", value: "\(stats.streak)")
            divider
            statRow(title: "Difficulty", value: stats.difficulty)
        }
    ...
    private var backgroundBlobs: some View {
        ZStack {
            ...
            Circle()
                .fill(Color(red: 0.45, green: 0.39, blue: 1.00).opacity(0.08))
                .frame(
